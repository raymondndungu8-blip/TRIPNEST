...
import { ArrowLeft, MessageCircle, Send, Car, Phone } from "lucide-react";
        ...
        {loading ? (
          ...
          <div className="flex h-full flex-col items-center justify-center text-center">
            ...
            <p className="text-sm text-muted-foreground">
              No messages yet. Say hi and coordinate your pickup!
            </p>
          </div>
        ) : (
    ...
    return (
      <AppShell>
        <ChatView
          ...
          driverSubtitle={`${activeChat.driver_vehicle} · ${activeChat.driver_plate}`}
              ...
              {conversations.map((convo) => (
                ...
                >
                  ...
                  <Car
                    className={cn(
                      "h-5 w-5 shrink-0",
                      convo.last_message ? "text-accent" : "text-muted-foreground/40"
                    )}
                  />
                </motion.button>
              ))}
