...
export function securityHeaders(request: NextRequest) {
  ...
  const cspDirectives = [
    ...
    "connect-src 'self' https://firestore.googleapis.com https://firebasestorage.googleapis.com https://identitytoolkit.googleapis.com https://securetoken.googleapis.com https://www.googleapis.com https://oauth2.googleapis.com https://accounts.google.com https://www.gstatic.com https://api.africastalking.com https://maps.googleapis.com https://*.stripe.com https://fcm.googleapis.com https://*.firebaseio.com wss://firestore.googleapis.com",
